                ...
                <div class="dropdown wizard-dropdown dropdown-trigger">
                    ...
                    <div id="wizard-navigation-dropdown" class="dropdown-menu" role="menu">
                        <div class="dropdown-content">
                            ...
                            <?php
                                # code...
                            } elseif (isset($_POST['save-acc'])) {
                            ?>
                                <a href="javascript:void(0);" class="dropdown-item kill-drop" data-dropdown-step="0">
                                    Step 1: Business Files
                                </a>
                                <a href="javascript:void(0);" class="dropdown-item kill-drop is-disabled" data-dropdown-step="1">
                                    Step 2: Team members
                                </a>
                            ...
                            ?>
                                <a href="javascript:void(0);" class="dropdown-item kill-drop is-disabled" data-dropdown-step="0">
                                    Step 4: Business Preview
                                </a>
                            <?php
                            }
                            ?>
              ...
              <div class="file is-boxed is-default">
                  <label class="file-label">
                      ...
                      <span class="file-cta">
                              ...
                              Choose a file…
                                        ...
                                        <div class="project-info">
                                            <div class="project-name">
                                                <div class="field">
                                                    <div class="control">
                                                        <input id="project-name" name="name" required class="input" placeholder="Votre Nom" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="project-name">
                                                <div class="field">
                                                    <div class="control">
                                                        <input type="password" min="8" name="password" required id="project-name" class="input" placeholder="Un mot de passe" />
                                                    </div>
                                            ...
                                            <div class="project-description p-t-10">
                                                <div class="field">
                                                    <div class="control">
                                                        <input type="tel" name="telephone" min="9" id="project-name" required class="input" placeholder="Votre Numéro de téléphone" />
                                                    </div>
                                ...
                                <div class="project-customer">
                                    ...
                                    <div class="field is-autocomplete">
                                        <div class="control has-icon">
                                            <input id="customers-search" name="business-name" required class="input" placeholder="... " />
                                            <div class="form-icon">
                                ...
                                <div class="project-dates">
                                    ...
                                    <div class="project-dates-inner">
                                        <div class="project-date">
                                            ...
                                            <div class="control">
                                                <input class="input" name="business-adress" required placeholder="Location" />
                                            </div>
                                        </div>
                        ...
                        <div id="wizard-step-3" class="inner-wrapper" data-step-title="Finish">
                            <!--src/partials/pages/wizard/wizard-v1/-->
                            <div class="step-content">
                                <div class="step-title">
                                    <h2 class="dark-inverted">Congrats! You're all set.</h2>
                                    <p>Awesome, Nous allons créer votre compte.</p>
                                </div>
                                ...
                                <div class="page-placeholder end-placeholder">
                                    <div class="placeholder-content">
                                        ...
                                        <!-- <p>
                                                Votre Business est crée. Procédons à sa structuration
                                            </p> -->
                                        <div class="button-wrap">
                                            <button type="submit" name="save-acc" class="button h-button is-rounded is-bold is-elevated is-primary">Continuer</button>
                                        </div>                                        
                                    </div>
                                </div>
                            </div>
                    ...
                    ?>
                        <div id="wizard-step-0" class="inner-wrapper is-active" data-step-title="Project Files">
                            <!--src/partials/pages/wizard/wizard-v1/-->
                            <div class="step-content">
                                <div class="step-title">
                                    ...
                                    <div id="actions" class="uploader-toolbar">
                                        <div class="left">
                                            <div class="uploader-actions">
                                                ...
                                                <div class="uploader-action">
                                                    <button type="button" class="inner-action start hint--bubble hint--primary hint--top" data-hint="Upload All">
                        ...
                        <div id="wizard-step-1" class="inner-wrapper" data-step-title="Team Members">
                            <!--src/partials/pages/wizard/wizard-v1/-->
                            <div class="step-content">
                                <div class="step-title">
                                ...
                                <div class="project-team-wrapper is-hidden">
                                    <div class="project-team-header">
                                        <div class="field is-autocomplete">
                                            <div class="control has-icon">
                                                <input id="add-member" class="input" name="member" placeholder="Entrer un numéro de telephone" />
                                                <div class="form-icon">
                                                    <i data-feather="search"></i>
                                                </div>
                                            </div>
                                            <div class="control has-icon">
                                                <select name="member-rol" class="input" id="">
                        ...
                        <div id="wizard-step-2" class="inner-wrapper" data-step-title="Project Tools">
                            <!--src/partials/pages/wizard/wizard-v1/-->
                            <div class="step-content">
                                <div class="step-title">
                    ...
                    <?php
                    } elseif (isset($_POST['allset'])) {
                    ?>
                        <div id="wizard-step-0" class="inner-wrapper is-active" data-step-title="Preview">
                            <!--src/partials/pages/wizard/wizard-v1/-->
                            <div class="step-content">
                                <div class="step-title">
