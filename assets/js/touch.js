  ...
  (e = function (e, t) {
    ...
    void 0 !== window.orientation &&
      ($(".sidebar-panel .inner").each(function () {
        ...
        new Hammer(this).on("swipeleft", function () {
          console.log("Swipe left detected."),
            e.closest(".sidebar-panel").removeClass("is-active"),
            $(".huro-hamburger .icon-box-toggle").removeClass("active");
        });
      }),
      $(".sidebar-search .inner").each(function () {
        ...
        new Hammer(this).on("swipeleft", function () {
          console.log("Swipe left detected."),
            e.closest(".sidebar-search").removeClass("is-active"),
            $(".huro-hamburger .icon-box-toggle").removeClass("active");
        });
      }),
      $(".is-messages #conversations-list").each(function () {
        ...
        new Hammer(this).on("swipeleft", function () {
          console.log("Swipe left detected."),
            e.closest(".is-messages").removeClass("is-active"),
            $(".huro-hamburger .icon-box-toggle").removeClass("active");
        });
      }),
      ...
      $(".conversation-area .conversation").each(function () {
        ...
        new Hammer(this).on("swipeleft", function () {
          console.log("Swipe left detected."),
            e.closest(".conversation-area").removeClass("is-active");
        });
      }));
});
